...
PaletteProvider.prototype.getPaletteEntries = function (element) {
  ...
  return {
    "create.start-event": {
      ...
      title: "创建开始节点",
      imageUrl: require('../../assets/imgs/start.png'),
      action: {
    ...
    "create.one-task": {
      group: "model",
      className: "icon-custom icon-custom-one",
      title: "创建一个类型为lindaidai-task的任务节点",
      imageUrl: require('../../assets/imgs/rules.png'),
      action: {
    ...
    "create.end-event": {
      group: "event",
      className: "icon-custom icon-custom-end bpmn-icon-end-event-none",
      title: "创建结束节点",
      // imageUrl: require('../../assets/imgs/start.png'),
      action: {
